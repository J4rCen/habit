...
export const GoogleSvg = ({ size }: ISvgSettings) => {
    return (
        <Svg width={size} height={size} viewBox="-3 0 262 262" preserveAspectRatio="xMidYMid" fill="#000000">
...
export const YandexSvg = ({ size }: ISvgSettings) => {
    return (
        <Svg  width={size} height={size} viewBox="0 0 1080 1080" >
            <Circle cx="540" cy="540" r="538.9" fill="#EB4335"/>
            <Path id="Glyph" d="M735,878.3H616.7V293.2H564c-96.6,0-147.2,48.3-147.2,120.4c0,81.8,34.9,119.7,107.1,168l59.5,40.1l-171,256.5H285.2l153.9-229c-88.5-63.2-138.3-124.9-138.3-229c0-130.1,90.7-218.6,262.4-218.6h171v676.5H735z" fill="#fff"/>
        </Svg>
    )
}